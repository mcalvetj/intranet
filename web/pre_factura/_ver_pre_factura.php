...
if($_GET['ok']=='eliminarArticulo'){
    ...
    <script>
        swal({
                title: "Eliminación de articulo completada!",
                text: "",
                type: "success",
...
if($_GET['ok']=='eliminarServicio'){
    ...
    <script>
        swal({
            title: "Eliminación de servicio completada!",
            text: "",
            type: "success",
            showConfirmButton: false,
            timer: 2000
...
if($_GET['ok']=='eliminarMinutaje'){
    ...
    <script>
        swal({
                title: "Eliminación de minutaje completada!",
                text: "",
                type: "success",
            showConfirmButton: false,
            timer: 2000
                                    ...
                                    <form id="crear_factura" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div id="anadirComentario" style="float:left">
                                                <div class="form-group">
                                                    <a onclick='anadirComentario();' class="btn btn-success btn-default" style="cursor:pointer">Añadir comentario <span class="glyphicon glyphicon-plus"></span></a>
                                                </div>
                                            </div>
                                            ...
                                            <div id="tituloComentario" style="font: bold 150% sans-serif;">Comentarios: </div><input style="border: 0; margin-top:5px; margin-bottom:10px;" type="text" name="comentarioPrefactura" id="comentarioPrefactura" value="<?php echo $comentarioPrefactura ?>" disabled/>
