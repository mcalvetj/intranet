...
if ($_GET['error'] == 'preFacturaMinutaje') {
    ?>
    <script>
        swal({
                title: "Error",
                text: "El minutaje no se ha podido prefacturar",
                type: "error",
            ...
            function () {
                window.location.href = 'pre_factura_minutaje.php';
            });
    </script>
    <?php
}
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand"><?php echo "Pre-facturar minutaje - $nombre_pre_factura"; ?></a>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title"> Pre_facturar minutajes </h4>
                            </div>
                            <div class="content">
                                <form id="contact" action="../assets/php/facturar/pre_factura_minutaje_post.php"
                                    ...
                                    for ($i = 1; $i <= count($id_array) - 1; $i++) {
                                        ...
                                        if ($data->num_rows > 0) {
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label> COMENTARIO(disabled)</label>
