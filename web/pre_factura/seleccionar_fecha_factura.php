                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="container">
                                ...
                                <form id="contact" action="../assets/php/facturar/crear_factura.php" method="post" onsubmit="return checkSubmit();" name="f_cliente_sede">
                                    ...
                                    <fieldset>
                                        <button name="submit" type="submit" id="btnsubmit">Facturar
                                        </button>
