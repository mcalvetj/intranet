                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="container">
                                ...
                                $date2 = date('d-m-Y', $last_factura);
                                ?>

                                <form id="contact" name="contact" action="../assets/php/facturar/crear_factura_correo.php" method="post"
                                      name="f_cliente_sede">
                                    ...
                                    <h4>La fecha de la factura tiene que ser posterior a <?php echo $date2; ?></h4>
                                    ...
                                    <?php
                                        $nifCliente = get_cliente_pre_factura($id_pre_factura);
                                        $correoContacto = select_correo_cliente_factura($nifCliente);
                                    ?>

                                    <div id="tituloComentario" style="font: bold 150% sans-serif;">Comentario: </div>
                                                <input type="text" name="comentario" value="<?php echo $comentario ?>" required/>

                                    <div id="tituloComentario" style="font: bold 150% sans-serif;">Correo: </div>
                                                <input type="text" name="correoContacto" value="<?php echo $correoContacto ?>" required/>

                                    <div style="visibility: hidden;" id="correo"></div>

                                    


                                    <fieldset>
                                        <button name="submit" type="submit" id="btnsubmit">Facturar y enviar
                                        </button>
