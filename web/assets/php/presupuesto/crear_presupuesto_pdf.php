        ...
        <div id="container">
            <div id="cabecera_facrura">
                <div id="datos_cliente">
                    ...
                    $year=date("Y");
                    $year=substr( $year, -2 );
                    $data = get_cabecera_presupuesto($id_presupuesto);
                    if ($data->num_rows > 0) {
                        // output data of each row
            ...
            <div id="tronco_factura">
                <div id="id_fecha">
                    <div id="id_factura">
                        <a>Nº<?php echo" Presupuesto: P". $year."_".$id_presupuesto ?></a>
                    </div>
                    <div id="fecha_factura">
                        <?php
                        $timestamp = $fecha_presupuesto;
                ...
                <div id="div_tabla_factura">
                    ...
                    <table id="tabla_factura">
                        ...
                        <?php
                        //FACTURA ARTICULOS
                        $productos_presupuesto = get_productos_presupuesto($id_presupuesto);
                        if ($productos_presupuesto->num_rows > 0) {
                            // output data of each row
                            while ($row = $productos_presupuesto->fetch_assoc()) {
                                ?>
                                <tr>
            ...
            <div id="pie_factura">
                ...
                $data = get_pie_presupuesto($id_presupuesto);
                if ($data->num_rows > 0) {
                    // output data of each row
                    while ($row = $data->fetch_assoc()) {
...
$dompdf->render();
/*$pdf = $dompdf->output();
$filename = "../../../presupuesto_pdf/".$year."_".$id_presupuesto.".pdf";
file_put_contents($filename, $pdf);*/
ob_end_clean();
$dompdf->stream("Presupuesto ".$year."_".$id_presupuesto.".pdf");