    ...
    <main>
        <div id="container">
            ...
            <div id="tronco_factura">
                <div id="id_fecha">
                    <div id="id_factura">
                        <a>N� Fact. <?php echo $ID_FACTURA ?></a>
                    </div>
            ...
            <div id="pie_factura">
                ...
                <table id="tabla_entidades">
                    <tr>
                        <td>La Caixa:</td>
                        <td>ES27 2100 3031 8322 0067 5049</td>
                        <td>BIC:</td>
                        <td>CAIX ESBB</td>
                    </tr>
                    <tr>
...
$carpeta = '../../../factura_pdf/'.$anyo.'/';

if (!file_exists($carpeta)) {
    mkdir($carpeta, 0777, true);
}

$carpeta = '../../../factura_pdf/'.$anyo.'/'.$mes.'/';

if (!file_exists($carpeta)) {
    mkdir($carpeta, 0777, true);
}

$filename = "../../../factura_pdf/".$anyo."/".$mes."/".$ID_FACTURA.".pdf";
