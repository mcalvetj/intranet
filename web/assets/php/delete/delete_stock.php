            ...
            <div class="container-fluid">
                <div class="row">
                    <div >
                        <div >
                        <?php
                        $id_codigo_de_barras = $_GET['id'];
                       $conn = connect();
                       $sql = "DELETE FROM STOCK WHERE CODIGO_DE_BARRAS = '".$id_codigo_de_barras."'";
                        ...
                        <div id="precargador">
                            ...
                            var maxprogress = 500;
                                ...
                                function prog()
                                {
                                  ...
                                  progressnum.innerHTML = "Eliminando stock...";
                                  if (actualprogress==300){
                                    window.location="../../../buscador/buscador_stock.php";
                                  }
                                }
                            </script>
